...
var TestBed = (function() {
  ...
  TestBed.prototype.overrideView = function(component, view) {
    this._injector.get(view_resolver_1.ViewResolver).setView(component, view);
  };
  TestBed.prototype.setInlineTemplate = function(component, html) {
    this._injector.get(view_resolver_1.ViewResolver).setInlineTemplate(component, html);
  };
  TestBed.prototype.overrideDirective = function(component, from, to) {
    this._injector.get(view_resolver_1.ViewResolver).overrideViewDirective(component, from, to);
  };
